...
import AnimatedBlogCover from '@/components/Blog/AnimatedBlogCover'

import AnimatedBlogDetails from '@/components/Blog/AnimatedBlogDetails'

import MeetTheTeamsHero from '@/components/Meet-the-teams'
...
const MEET_THE_TEAMS_SLUG = 'Blog_1'
...
export default async function Post({ params }: any) {
  ...
  const isMeetTheTeamsPage = slug === MEET_THE_TEAMS_SLUG
  ...
  const coverSrc = String(post.coverImage || '').replace(/\\/g, '/')
    ...
    <>
      ...
      {isMeetTheTeamsPage ? (
        ...
        <MeetTheTeamsHero
          ...
          description={meetTeamsDescription}

          breadcrumbLinks={[

            { href: '/', text: 'Home' },

            { href: `/blog/${MEET_THE_TEAMS_SLUG}`, text: 'Meet the teams' },
          ...
          <div className='container max-w-6xl mx-auto'>
            ...
            <div className='grid md:grid-cols-12 grid-cols-1 items-center'>
              ...
              <div className='col-span-12'>
                ...
                <h2 className='text-midnight_text dark:text-white md:text-[40px] leading-tight text-4xl font-bold pt-7 text-center md:text-center'>
          ...
          <div className='-mx-4 flex flex-wrap justify-center'>
            ...
            <div className='w-full px-4'>
              ...
              {isMeetTheTeamsPage ? (
                ...
                <AnimatedBlogCover src={coverSrc} alt={post.title || ''} />
                ...
                <div className='w-full px-4 lg:w-8/12'>
                  ...
                  {isMeetTheTeamsPage ? (
                    ...
                    <AnimatedBlogDetails
                      ...
                      className='blog-details xl:pr-10'
