...
interface HeroSubProps {
  ...
  /**
   * Use this only on the template where you want to remove the card body.
   * Example: "hero-sub-portfolio"
   */
  sectionId?: string
}
...
const HeroSub: FC<HeroSubProps> = ({
  ...
  const isPortfolioTemplate = sectionId === 'hero-sub-portfolio'

  return (
    <>
    <section
      id={sectionId}
      className="bg-[#f5f6f8] py-16 pt-36 dark:bg-darkmode md:py-24 md:pt-44">
      <div className="container mx-auto max-w-5xl px-4">
        ...
        {isPortfolioTemplate ? (
          <>
            <p className="mx-auto mb-8 max-w-2xl text-center text-base leading-relaxed text-gray-600 dark:text-white/70 md:text-lg">
              {description}
            </p>
