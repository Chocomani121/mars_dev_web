...
interface MeetTheTeamsHeroProps {
  title: string
  description: string
...
const MeetTheTeamsHero: FC<MeetTheTeamsHeroProps> = ({
  title,
  description,
  breadcrumbLinks,
}) => {
  return (
    <section className="relative overflow-hidden bg-[#f8fafc] py-16 pt-36 dark:bg-slate-900 md:py-24 md:pt-44">
      <motion.div
        ...
        className="absolute -left-24 bottom-0 h-96 w-96 rounded-full bg-blue-100/30 blur-3xl dark:bg-blue-900/10"
      />
        ...
        <div className="relative min-h-[500px] w-full">
          ...
          <motion.div
            ...
            <motion.div
              ...
              <motion.p
                variants={itemVariants}
                className="mt-8 text-lg leading-relaxed text-orange-50/90 md:text-xl">
                {description}
              </motion.p>
...
export default MeetTheTeamsHero
