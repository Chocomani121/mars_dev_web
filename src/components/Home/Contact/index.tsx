      ...
      <div className='container mx-auto max-w-6xl px-4'>
        <div className='grid md:grid-cols-12 grid-cols-1 md:gap-7 gap-0'>
          ...
          <div
            ...
            <div className='lg:mt-0 mt-8 bg-white/10 backdrop-blur-lg border border-red-black max-w-[50rem] m-auto pt-[2.1875rem] pb-8 px-[2.375rem] rounded-xl relative z-10'>            
            <h2 className='sm:text-3xl text-lg font-bold text-midnight_text mb-3 dark:text-text-black'>
                Start the project
              </h2>
              <form className='flex w-full m-auto justify-between flex-wrap gap-4'>
                ...
                <div className='w-full'>
                  <button
                    className='w-full bg-orange hover:bg-blue-700 text-white py-3 rounded-lg'
                    type='submit'>
                    Submit Inquiry
                  </button>
                </div>
