...
const Hero = () => {
  return (
 <section className='relative md:pt-100 pt-70 bg-white dark:bg-orange bg-[url(/images/hero/construction-site.jpg)] bg-cover bg-center bg-no-repeat text-white'>
