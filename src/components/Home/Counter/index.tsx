  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="relative bg-white dark:bg-white rounded-[2rem] shadow-xl p-10 md:p-16 text-center border-t-4 border-orange">
          
          {/* Decorative Quotation Mark */}
        <div className="absolute -top-6 left-10 text-teal scale-x-[-1]">
          ...
          <p className="text-xl md:text-2xl font-serif text-slate-700 dark:text-teal leading-relaxed italic">
